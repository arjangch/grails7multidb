...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-students" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="create-students" class="col-12 content scaffold-create" role="main">
                ...
                <g:form resource="${this.students}" controller="${controllerName}" method="POST">
                    <fieldset class="form">
                        <f:all bean="students" class="row" requiredClass="mb-3 required" labelClass="col-sm-2 col-form-label text-sm-end" divClass="col-sm-10" widget-class="form-control" widget-invalidClass="is-invalid" />
                    </fieldset>
