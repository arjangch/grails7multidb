...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#show-students" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="show-students" class="col-12 content scaffold-show" role="main">
                ...
                <g:form resource="${this.students}" controller="${controllerName}" method="DELETE">
                    <fieldset class="bg-body-tertiary">
                        <g:link class="btn btn-outline-primary" action="edit" resource="${this.students}" controller="${controllerName}">
